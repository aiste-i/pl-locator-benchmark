...
test.describe('Authentication', () => {
  ...
  test('should login with existing user', async ({ page }) => {
    ...
    await expect(page.locator(hrefSelector(appPaths.login()))).toBeVisible();
    // Login again
  ...
  test('should logout successfully', async ({ page }) => {
    ...
    await expect(page.locator(hrefSelector(appPaths.profile(user.username)))).not.toBeVisible();
  });

  test('should prevent accessing editor when not logged in', async ({ page }) => {
    await page.goto(appPaths.editor());
    // Should be redirected to login or home
    await expect(page).not.toHaveURL(pathRegex(appPaths.editor()));
  });
  ...
  test('should handle invalid token on page reload gracefully', async ({ page }) => {
    ...
    await expect(page.locator(hrefSelector(appPaths.login()))).toBeVisible();
    await expect(page.locator(hrefSelector(appPaths.register()))).toBeVisible();
