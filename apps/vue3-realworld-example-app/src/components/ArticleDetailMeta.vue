<template>
  <div class="article-meta" data-testid="article-meta">
    ...
    >
      <img :alt="article.author.username" :src="article.author.image" data-testid="article-author-img">
    </AppLink>
    ...
    <div class="info" data-testid="article-info">
      ...
      <span class="date" data-testid="article-date">{{ (new Date(article.createdAt)).toLocaleDateString() }}</span>
    </div>
    ...
    >
      ...
      <span class="counter" data-testid="article-favorite-count">({{ article.favoritesCount }})</span>
    </button>
